...
{   
    public function get_general_records (){
        ...
        if ($queryIn=='teacher-files') {
            ...
            $defaultImage=$publicFolder.'/images/default-file-image.jpg';
        ...
        if ($queryIn=='articles') {
            ...
            $defaultImage=$publicFolder.'/images/default-article-image.jpg';
        ...
        if ($queryIn=='researches') {
            ...
            $defaultImage=$publicFolder.'/images/default-research-image.jpg';
        ...
        if ($queryIn=='tools') {
            ...
            $defaultImage=$publicFolder.'/images/default-tool-image.jpg';
        ...
        if ($sqlRecordsResult->num_rows>0) { 
            ...
            if ($queryIn == 'general-contents') {
                ...
                if ($resultTable == 'school_researches') {
                    ...
                    $registrantIdColumn= 'school_researchSchool';
                    $imageColumn = 'school_researchImage';
                    $defaultImage=$publicFolder.'/images/research.jpg';
                    $pageLink=$publicFolder.'/researches/';
                    $type = 'Research';
        ...
        if ($isWorkspace) {
            ...
            $editHref = $publicFolder.$workspace.'?edit=yes&'.$workspaceType.'='.$resultId;
    ...
    public function get_website_manager_records (){
        if (isset($_POST['get_site_manager_records_submit'])){

            $conn=  config('app.config');
            $publicFolder= config('app.publicFolder');
            $privateFolder = config('app.privateFolder');
            $websiteManagerSuperManagerRegistration = htmlspecialchars($_POST['wm_super_manager_registration']);
    ...
    public function update_website_manager_registrations (){
    ...
    public function initialize_subscription (){
        if (isset($_POST['initialize_subscription_submit'])){
            ...
            $toolSubscribed = htmlspecialchars($_POST['tool_subscribed']);
            $pendingToolSubscription = htmlspecialchars($_POST['pending_tool_subscription']);

            $fileSubscribed = htmlspecialchars($_POST['file_subscribed']);
            $pendingFileSubscription = htmlspecialchars($_POST['pending_file_subscription']);

            $sellerSubscribed = htmlspecialchars($_POST['seller_subscribed']);
            $pendingSellerSubscription = htmlspecialchars($_POST['pending_seller_subscription']);

            $shelfSubscribed = htmlspecialchars($_POST['shelf_subscribed']);
            $pendingShelfSubscription = htmlspecialchars($_POST['pending_shelf_subscription']);
    ...
    public function subscribe (){
        if(isset($_POST['subscription_submit'])) {
               ...
               $teacherRegistration = htmlspecialchars($_POST['teacher_registration']);
               $registrantId = htmlspecialchars($_POST['registrant_id']);
    ...
    public function update_promotion_status (){
        ...
        if (isset($_POST['update_promotion_status_submit'])) {
    ...
    public function update_subscription (){
        ...
        if (isset($_POST['update_subscription_submit'])) {
    ...
    public function get_message_users (){
        if (isset($_POST['get_message_users_submit'])){
            $conn= config('app.conn');
            $publicFolder= config('app.publicFolder');
            $privateFolder= config('app.privateFolder');
            $registrantCode = htmlspecialchars($_POST['regsitrant_code']);
            $registrantId = htmlspecialchars($_POST['regsitrant_id']);
    ...
    public function get_updates (){
        if (isset($_POST['get_updates_submit'])){
            ...
            $websiteManagerMessageManagerRegistration = htmlspecialchars($_POST['wm_message_manager_registration']);
              $websiteManagerSuperManagerRegistration = htmlspecialchars($_POST['wm_super_manager_registration']);
            $registrantId = htmlspecialchars($_POST['registrant_id']);
    ...
    public function add_update (){
        if (isset($_POST ['add_update_submit'])){
    ...
    public function update_update_status (){
