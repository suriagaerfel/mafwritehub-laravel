...
{   
     public function get_content_info (){
        ...
        if (isset($_POST['get_content_info_submit'])) {
            ...
            if ($queryIn == 'writer_articles') {
                ...
                $defaultImage=$publicFolder.'/images/default-featured-image.jpg';
     ...
     public function get_tool_files (){
...
public function save_content(){
    if (isset($_POST['save_content_submit'])) {
            ...
            $registrantId= htmlspecialchars($_POST['registrnt_id']);
            $contentId = htmlspecialchars($_POST['content_id']);
...
public function upload_tool_file (){
...
public function delete_sub_content (){
...
public function pin_unpin_article (){
...
public function update_content_status (){
...
// public function get_content_comments (){
...
public function track_content_performance (){
...
public function get_purchase_content_info (){
    if (isset($_POST['get_purchase_content_info_submit'])){
        ...
        if ($contentType=='Teacher File') {
            ...
            $amountColumn = 'teacher_fileAmount';
            $slugColumn = 'teacher_fileSlug';
            $pageLink = $publicFolder.'/teacher-files/view/';
        }
...
public function purchase_content (){
...
public function get_content_purchases (){
    if(isset($_POST['get_content_purchases_submit'])){

        $conn= config('app.conn');
        $registrantId= htmlspecialchars_decode($_POST['registrant_id']);
        $publicFolder= config('app.publicFolder');
        $privateFolder= config('app.privateFolder');
        ...
        if ($sqlContentPurchasesResult->num_rows > 0) {
            ...
            while($contentPurchases = $sqlContentPurchasesResult->fetch_assoc()){
                ...
                <div id='".'payment-proof-for-purchase-'.$contentPurchaseId."' style='display: none;' class='payment-proof'>
                    <img src='". $publicFolder.'/images/return.png'."' class='icons' id='hide-purchase-proof'>
                    <br>
